...
// My zoo has 7 unicorns! will be the result which is a string data type.
...
var dogName = "Penny";
var dogBreed = "Chocolate lab";
var dogsOwned = 1;
console.log(`We have ${dogsOwned} dog and she is a ${dogBreed} named ${dogName}!`);
